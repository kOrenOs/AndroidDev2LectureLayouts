...
/**
 * Created by Markos on 15. 9. 2016.
 */
public class PhoneArrayAdapter extends ArrayAdapter<String>{
    ...
    public PhoneArrayAdapter(Context contextArg, ArrayList<String> phonesArg){
        super(contextArg, R.layout.rowlayout, R.id.textView, phonesArg);
        context = contextArg;
        phones = phonesArg;
    }
